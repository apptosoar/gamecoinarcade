const translations = {
  ko: {
    ...
    gameDescriptions: {
      ...
      "burst-tap": "30초 안에 최대한 많이 탭하세요. 10번째 탭마다 보너스가 터집니다.",
  ...
  en: {
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Tap as much as you can in thirty seconds — every tenth tap sets off a bonus burst.",
...

{
  ...
  translations.es = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Toca todo lo que puedas en treinta segundos: cada décimo toque desata una bonificación.",
  ...
  translations.zh = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "在三十秒内尽可能多地点击——每第十次点击都会触发奖励爆发。",
  ...
  translations.ja = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "30秒間でできるだけ多くタップしよう。10回ごとにボーナスが弾けます。",
  ...
  translations.de = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Tippe in dreißig Sekunden so oft du kannst — jeder zehnte Tipp löst einen Bonus aus.",
  ...
  translations.fr = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Tapez autant que possible en trente secondes : chaque dixième frappe déclenche un bonus.",
  ...
  translations.hi = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "तीस सेकंड में जितना हो सके टैप करें — हर दसवां टैप बोनस विस्फोट करता है।",
  ...
  translations.cs = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Klepejte co nejvíc během třiceti sekund — každé desáté klepnutí spustí bonus.",
  ...
  translations.nl = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Tik zo vaak mogelijk in dertig seconden — elke tiende tik geeft een bonus.",
  ...
  translations.fi = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Napauta niin monta kertaa kuin ehdit kolmessakymmenessä sekunnissa — joka kymmenes laukaisee bonuksen.",
  ...
  translations.he = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "הקישו כמה שיותר בשלושים שניות — כל הקשה עשירית מפעילה בונוס.",
  ...
  translations.ro = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Atinge cât poți de mult în treizeci de secunde — fiecare a zecea atingere declanșează un bonus.",
  ...
  translations.uk = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Тапайте якомога більше за тридцять секунд — кожен десятий тап дає бонус.",
  ...
  translations.pt = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Toque o máximo que conseguir em trinta segundos — a cada décimo toque explode um bônus.",
  ...
  translations.id = mk({
    ...
    gameDescriptions: {
      ...
      "burst-tap": "Ketuk sebanyak mungkin dalam tiga puluh detik — setiap ketukan kesepuluh memicu bonus.",
...
const gameMeta = [
  ...
  { id: "burst-tap", genre: "action", title: "Burst Tap", icon: "BT", accent: "#a98bff", url: "./games/burst-tap/index.html" },
...
function detectLocale() {
  ...
  // 2순위: localStorage 저장값 (직접 선택한 언어)
  const saved = normalizeLocale(localStorage.getItem("locale"));
  if (saved) return saved;
  // 3순위: 브라우저 언어/지역. 예전에는 여기서 IP 기반 국가 조회로 이 값을 덮어썼지만,
  // 방문자 IP를 제3자에게 보내는 데다 사용자가 직접 정한 브라우저 언어보다 우선했습니다.
...
// The header nav is hidden below 900px, so the same destinations move into a
// dropdown here. Without it Blog and Community are unreachable on a phone.
function buildMobileMenu() {
  ...
  const items = [
    { href: "#games", label: copy.navGames },
    { href: "/blog.html", label: copy.navBlog },
    { href: "/community.html", label: copy.navCommunity },
    { href: "/about.html", label: copy.navAbout || "About" },
  ];
...
function renderHome() {
  app.innerHTML = `
    <div class="app-home">
      ...
      <div class="lp-hero">
        <picture>
          <source srcset="./assets/hero-game-portal.webp" type="image/webp" />
...
function siteFooter() {
  // every locale carries the full footer copy, so there is nothing to fall back from
  const fc = copy;
  return `
    <footer class="site-footer">
      ...
      <nav aria-label="${fc.mainMenu}">
        <a href="/blog.html">${fc.navBlog}</a>
        <a href="/community.html">${fc.navCommunity}</a>
